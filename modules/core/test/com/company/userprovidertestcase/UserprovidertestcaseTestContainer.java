package com.company.userprovidertestcase;
...
public class UserprovidertestcaseTestContainer extends TestContainer {

    public UserprovidertestcaseTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/userprovidertestcase/app.properties",
    ...
    public static class Common extends UserprovidertestcaseTestContainer {

        public static final UserprovidertestcaseTestContainer.Common INSTANCE = new UserprovidertestcaseTestContainer.Common();
